...
import { Eye, Download, Mail, Search, Filter, ChevronUp, ChevronDown, ArrowUpDown } from 'lucide-react';
...
export default function InvoicesPage() {
  ...
  const handleSendReminder = (invoice: Invoice) => {
    ...
    const body = `Dear ${invoice.client_name},\n\nThis is a friendly reminder that invoice ${invoice.id} for R${invoice.total.toFixed(2)} is due on ${new Date(invoice.due_date).toLocaleDateString()}.\n\nPlease let us know if you have any questions.\n\nThank you for your business!\n\nBest regards,\nYour Company Name`;
