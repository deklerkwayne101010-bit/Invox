...
export default function Dashboard() {
  ...
  invoices.forEach(invoice => {
    ...
    const monthIndex = last6Months.findIndex(m =>
      date.toLocaleDateString('en-US', { month: 'short' }) === m.month
    );
    if (monthIndex !== -1) {
      ...
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  <Link href="/analytics" className="text-xs text-primary hover:text-primary-dark flex items-center gap-1">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-accent">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  <Link href="/analytics" className="text-xs text-accent hover:text-accent-dark flex items-center gap-1">
                    Analyze expenses →
                  </Link>
                </div>
              </div>
          ...
          <div className={`bg-white p-6 rounded-xl shadow-lg border-l-4 ${profitLoss >= 0 ? 'border-green-500' : 'border-red-500'}`}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  <Link href="/analytics?type=profit-loss" className={`text-xs ${profitLoss >= 0 ? 'text-green-600 hover:text-green-700' : 'text-red-600 hover:text-red-700'} flex items-center gap-1`}>
                    View P&L report →
                  </Link>
                </div>
              </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-accent-dark">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  <Link href="/analytics?type=cash-flow" className="text-xs text-accent-dark hover:text-primary flex items-center gap-1">
                    Cash flow analysis →
                  </Link>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <Link
              href="/expense/new"
              className="bg-gradient-to-r from-secondary to-accent text-white px-6 py-3 rounded-lg hover:from-accent hover:to-secondary transition-all inline-flex items-center gap-2 shadow-lg"
            >
              <Plus size={20} />
              Add New Expense
            </Link>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-4">
              ...
              <Link
                href="/invoice/new"
                className="bg-gradient-to-r from-primary to-primary-dark text-white px-6 py-3 rounded-lg hover:from-primary-dark hover:to-primary transition-all flex items-center gap-2 shadow-lg"
              >
                <Plus size={20} />
                Create New Invoice
              </Link>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          {expenses.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <Link
                href="/expense/new"
                className="bg-gradient-to-r from-secondary to-accent text-white px-8 py-3 rounded-lg hover:from-accent hover:to-secondary transition-all inline-flex items-center gap-2 shadow-lg"
              >
                <Plus size={20} />
